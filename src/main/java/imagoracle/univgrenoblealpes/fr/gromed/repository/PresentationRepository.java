...
public interface PresentationRepository extends JpaRepository<Presentation, Integer>{
    ...
    @Query(value = 
        ...
        "GROUP BY p.ID, CODECIP7, LIBELLEPRESTATION, ESTAUTORISE, ETATCOMMERCIALISATION, DATEDECLARATIONCOMMERCIALISATION, CODECIP13, AGREMENTCOLLECTIVITES, TAUXREMBOURSEMENT, PRIX, DROITREMBOURSEMENT, p.CODECIS, STOCKPHYSIQUE, STOCKLOGIQUE",
        nativeQuery = true
        )
